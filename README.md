...
1. Add Markdown front-matter with a unique identifier:
   ```md
   ---
   id: my-new-cool-note-identifier <!-- Never change this—it identifies your note -->
   ---

   # My Cool Note
   ...
   ```
2. Run `push my-cool-note.md`.
3. A new note will be created with an auto-generated block-quote:
   ```
   > Autogenerated, do not remove me.
   > id_my-new-cool-note-identifier
